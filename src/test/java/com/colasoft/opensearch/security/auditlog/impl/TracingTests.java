...
public class TracingTests extends SingleClusterTest {
    ...
    public void testHTTPTrace() throws Exception {
        ...
        String bulkBody =
                ...
                "{ \"delete\" : { \"_index\" : \"test\", \"_id\" : \"2\" } }"+System.lineSeparator();
    ...
    public void testAdvancedMapping() throws Exception {
        ...
        System.out.println(rh.executeGetRequest("myindex1/_doc/1?pretty=true&_source=true&_source_include=*.id&_source_exclude=entities&stored_fields=tags,counter", encodeBasicHeader("admin", "admin")).getBody());
