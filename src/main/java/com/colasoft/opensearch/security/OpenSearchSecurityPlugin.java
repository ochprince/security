...
import com.colasoft.opensearch.common.component.Lifecycle.State;
...
import com.colasoft.opensearch.security.action.configupdate.TransportConfigUpdateAction;
import com.colasoft.opensearch.security.action.tenancy.TenancyConfigRestHandler;
import com.colasoft.opensearch.security.action.tenancy.TenancyConfigRetrieveActions;
import com.colasoft.opensearch.security.action.tenancy.TenancyConfigRetrieveTransportAction;
import com.colasoft.opensearch.security.action.tenancy.TenancyConfigUpdateAction;
import com.colasoft.opensearch.security.action.tenancy.TenancyConfigUpdateTransportAction;
import com.colasoft.opensearch.security.action.whoami.TransportWhoAmIAction;
import com.colasoft.opensearch.security.action.whoami.WhoAmIAction;
...
import com.colasoft.opensearch.security.auditlog.AuditLogSslExceptionHandler;
import com.colasoft.opensearch.security.auditlog.NullAuditLog;
...
import com.colasoft.opensearch.security.compliance.ComplianceIndexingOperationListener;
import com.colasoft.opensearch.security.compliance.ComplianceIndexingOperationListenerImpl;
...
import com.colasoft.opensearch.security.configuration.DlsFlsValveImpl;
import com.colasoft.opensearch.security.configuration.PrivilegesInterceptorImpl;
import com.colasoft.opensearch.security.configuration.Salt;
import com.colasoft.opensearch.security.configuration.SecurityFlsDlsIndexSearcherWrapper;
import com.colasoft.opensearch.security.dlic.rest.api.SecurityRestApiActions;
import com.colasoft.opensearch.security.filter.SecurityFilter;
import com.colasoft.opensearch.security.filter.SecurityRestFilter;
import com.colasoft.opensearch.security.http.SecurityHttpServerTransport;
import com.colasoft.opensearch.security.http.SecurityNonSslHttpServerTransport;
...
import com.colasoft.opensearch.security.privileges.PrivilegesInterceptor;
import com.colasoft.opensearch.security.resolver.IndexResolverReplacer;
import com.colasoft.opensearch.security.rest.DashboardsInfoAction;
import com.colasoft.opensearch.security.rest.SecurityConfigUpdateAction;
import com.colasoft.opensearch.security.rest.SecurityHealthAction;
import com.colasoft.opensearch.security.rest.SecurityInfoAction;
import com.colasoft.opensearch.security.rest.SecurityWhoAmIAction;
import com.colasoft.opensearch.security.rest.TenantInfoAction;
import com.colasoft.opensearch.security.securityconf.DynamicConfigFactory;
import com.colasoft.opensearch.security.setting.OpensearchDynamicSetting;
import com.colasoft.opensearch.security.setting.TransportPassiveAuthSetting;
import com.colasoft.opensearch.security.ssl.OpenSearchSecuritySSLPlugin;
...
import com.colasoft.opensearch.security.ssl.rest.SecuritySSLCertsInfoAction;
import com.colasoft.opensearch.security.ssl.rest.SecuritySSLReloadCertsAction;
import com.colasoft.opensearch.security.ssl.transport.DefaultPrincipalExtractor;
import com.colasoft.opensearch.security.ssl.transport.SecuritySSLNettyTransport;
...
import com.colasoft.opensearch.security.support.GuardedSearchOperationWrapper;
import com.colasoft.opensearch.security.support.HeaderHelper;
import com.colasoft.opensearch.security.support.ModuleInfo;
import com.colasoft.opensearch.security.support.ReflectionHelper;
import com.colasoft.opensearch.security.support.SecuritySettings;
...
import com.colasoft.opensearch.security.transport.DefaultInterClusterRequestEvaluator;
import com.colasoft.opensearch.security.transport.InterClusterRequestEvaluator;
import com.colasoft.opensearch.security.transport.SecurityInterceptor;
...
public final class OpenSearchSecurityPlugin extends OpenSearchSecuritySSLPlugin implements ClusterPlugin, MapperPlugin {
    ...
    public Map<String, Supplier<Transport>> getTransports(Settings settings, ThreadPool threadPool, PageCacheRecycler pageCacheRecycler,
        ...
        if (transportSSLEnabled) {
            transports.put("com.colasoft.opensearch.security.ssl.http.netty.SecuritySSLNettyTransport",
    ...
    public Map<String, Supplier<HttpServerTransport>> getHttpTransports(Settings settings, ThreadPool threadPool, BigArrays bigArrays,
        ...
        if(!disabled) {
            if (!client && httpSSLEnabled) {
                ...
                return Collections.singletonMap("com.colasoft.opensearch.security.http.SecurityHttpServerTransport",
                        () -> odshst);
            } else if (!client) {
                return Collections.singletonMap("com.colasoft.opensearch.security.http.SecurityHttpServerTransport",
    ...
    public Settings additionalSettings() {
        ...
        if(!SSLConfig.isSslOnlyMode()){
            builder.put(NetworkModule.TRANSPORT_TYPE_KEY, "com.colasoft.opensearch.security.ssl.http.netty.SecuritySSLNettyTransport");
            builder.put(NetworkModule.HTTP_TYPE_KEY, "com.colasoft.opensearch.security.http.SecurityHttpServerTransport");
        }
