...
import com.colasoft.opensearch.security.auth.internal.NoOpAuthenticationBackend;
import com.colasoft.opensearch.security.auth.internal.NoOpAuthorizationBackend;
import com.colasoft.opensearch.security.http.HTTPBasicAuthenticator;
import com.colasoft.opensearch.security.http.HTTPClientCertAuthenticator;
import com.colasoft.opensearch.security.http.HTTPProxyAuthenticator;
import com.colasoft.opensearch.security.http.proxy.HTTPExtendedProxyAuthenticator;
...
public enum ModuleType implements Serializable {
	...
	REST_MANAGEMENT_API("REST Management API", "com.colasoft.opensearch.security.dlic.rest.api.SecurityRestApiActions", Boolean.TRUE),
	DLSFLS("Document- and Field-Level Security", "com.colasoft.opensearch.security.configuration.SecurityFlsDlsIndexSearcherWrapper", Boolean.TRUE),
	AUDITLOG("Audit Logging", "com.colasoft.opensearch.security.auditlog.impl.AuditLogImpl", Boolean.TRUE),
	MULTITENANCY("OpenSearch Dashboards Multi-tenancy", "com.colasoft.opensearch.security.configuration.PrivilegesInterceptorImpl", Boolean.TRUE),
	...
	// COMPLIANCE("Compliance", "com.colasoft.opensearch.security.compliance.ComplianceIndexingOperationListenerImpl", Boolean.TRUE),
