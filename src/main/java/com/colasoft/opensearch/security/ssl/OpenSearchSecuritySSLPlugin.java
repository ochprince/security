...
import com.colasoft.opensearch.security.NonValidatingObjectMapper;
...
import com.colasoft.opensearch.security.ssl.rest.SecuritySSLInfoAction;
...
import com.colasoft.opensearch.security.ssl.transport.SecuritySSLTransportInterceptor;
...
//    }
    ...
    public Map<String, Supplier<HttpServerTransport>> getHttpTransports(Settings settings, ThreadPool threadPool, BigArrays bigArrays,
        ...
        if (!client && httpSSLEnabled) {
            ...
            return Collections.singletonMap("com.colasoft.opensearch.security.ssl.http.netty.SecuritySSLNettyHttpServerTransport", () -> sgsnht);
    ...
    public Settings additionalSettings() {
       ...
       if(!client && httpSSLEnabled) {
           ...
           builder.put(NetworkModule.HTTP_TYPE_KEY, "com.colasoft.opensearch.security.ssl.http.netty.SecuritySSLNettyHttpServerTransport");
       }
