...
import com.colasoft.opensearch.test.framework.TestSecurityConfig;
import com.colasoft.opensearch.test.framework.cluster.ClusterManager;
import com.colasoft.opensearch.test.framework.cluster.LocalCluster;

import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.instanceOf;
import static org.hamcrest.Matchers.is;
import static com.colasoft.opensearch.action.admin.indices.alias.IndicesAliasesRequest.AliasActions.Type.ADD;
import static com.colasoft.opensearch.action.support.WriteRequest.RefreshPolicy.IMMEDIATE;
import static com.colasoft.opensearch.client.RequestOptions.DEFAULT;
import static com.colasoft.opensearch.security.Song.ARTIST_FIRST;
import static com.colasoft.opensearch.security.Song.ARTIST_NO;
import static com.colasoft.opensearch.security.Song.ARTIST_STRING;
import static com.colasoft.opensearch.security.Song.ARTIST_TWINS;
import static com.colasoft.opensearch.security.Song.ARTIST_UNKNOWN;
import static com.colasoft.opensearch.security.Song.ARTIST_YES;
import static com.colasoft.opensearch.security.Song.FIELD_ARTIST;
import static com.colasoft.opensearch.security.Song.FIELD_STARS;
import static com.colasoft.opensearch.security.Song.QUERY_TITLE_NEXT_SONG;
import static com.colasoft.opensearch.security.Song.SONGS;
import static com.colasoft.opensearch.test.framework.TestSecurityConfig.AuthcDomain.AUTHC_HTTPBASIC_INTERNAL;
import static com.colasoft.opensearch.test.framework.TestSecurityConfig.Role.ALL_ACCESS;
import static com.colasoft.opensearch.test.framework.cluster.SearchRequestFactory.averageAggregationRequest;
import static com.colasoft.opensearch.test.framework.matcher.SearchResponseMatchers.containAggregationWithNameAndType;
import static com.colasoft.opensearch.test.framework.matcher.SearchResponseMatchers.isSuccessfulSearchResponse;
import static com.colasoft.opensearch.test.framework.matcher.SearchResponseMatchers.numberOfTotalHitsIsEqualTo;
import static com.colasoft.opensearch.test.framework.matcher.SearchResponseMatchers.searchHitContainsFieldWithValue;
