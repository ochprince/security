...
*Example violation*
```
[ant:checkstyle] [ERROR] /local/home/security/src/main/java/com/colasoft/opensearch/security/configuration/DlsFlsValveImpl.java:178: Usage should be switched to cluster manager [RegexpSingleline]
```
